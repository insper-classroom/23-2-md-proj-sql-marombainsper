...
class Subscription(Base):
    ...
    id_user = Column(VARCHAR(60), ForeignKey('members.id', ondelete='CASCADE'), nullable=False)
    id_plan = Column(VARCHAR(60), ForeignKey('plans.id', ondelete='CASCADE'), nullable=False)
